...
const messages = {
  en: {
    ...
    save: 'Save',
    successPaletteTemplateCreate: 'The template was successfully saved!',
    addTemplate: 'Add template',
    successUpdatePaletteTemplate: 'Template updated successfully!',
    successDeletePaletteTemplate: 'Template deleted successfully!',
    template: 'Template',
    myTemplates: 'My templates',
    resetTemplate: 'Reset template',
    updateTemplate: 'Update template',
    analysisByPhoto: 'Analysis by photo',
    saveChanges: 'Save changes',
    reset: 'Reset',
    next: 'Next',
    selectTopColors: 'Please select the top colors',
    selectOneColor: 'Please select at least one color!',
    shapeOfElements: 'Shape of elements',
    ...
    arrangementElements: 'Arrangement of elements',
    columns: 'Columns',
    rows: 'Rows',
    ...
    of: 'of',
    grid: 'Grid',
    sizingSettings: 'Sizing settings',
    elementSize: 'Element size',
    spaceBetweenElements: 'Space between elements',
  ...
  ru: {
    ...
    save: 'Сохранить',
    successPaletteTemplateCreate: 'Шаблон успешно сохранен!',
    addTemplate: 'Добавить шаблон',
    successUpdatePaletteTemplate: 'Шаблон успешно обновлен!',
    successDeletePaletteTemplate: 'Шаблон успешно удален!',
    template: 'Шаблон',
    myTemplates: 'Мои шаблоны',
    resetTemplate: 'Сбросить шаблон',
    updateTemplate: 'Обновить шаблон',
    analysisByPhoto: 'Анализ по фото',
    saveChanges: 'Сохранить изменения',
    reset: 'Сбросить',
    next: 'Далее',
    selectTopColors: 'Пожалуйста, выберите верхние цвета',
    selectOneColor: 'Пожалуйста, выберите хотя бы один цвет!',
    shapeOfElements: 'Форма элементов',
    transformation: 'Трансформация',
    shadowSettings: 'Настройки тени',
    enableShadow: 'Включить тень',
    intensity: 'Интенсивность',
    yOffset: 'Смещение по Y',
    transparency: 'Прозрачность',
    arrangementElements: 'Расположение элементов',
    columns: 'Колонок',
    rows: 'Рядов',
    autoSelection: 'Авто подбор',
    auto: 'Авто',
    colors: 'Цветов',
    of: 'из',
    grid: 'Сетка',
    sizingSettings: 'Настройка размеров',
    elementSize: 'Размер элементов',
    spaceBetweenElements: 'Отступ между элементами',
    cutPalette: 'Вырезать цвета',
